    ...
    <main className="relative min-h-screen overflow-hidden bg-white selection:bg-cyan-100">
      ...
      <div className="relative mx-auto max-w-7xl px-6 pt-32 pb-24">
        ...
        <section className="max-w-4xl">
          ...
          <div className="mt-8 flex items-center gap-2 opacity-0 animate-reveal-up delay-700">
             <svg className="h-4 w-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
               <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
             </svg>
             <span className="text-xs text-slate-400">隐私承诺：您的简历数据采用临时会话机制，绝不永久存储于服务器。</span>
          </div>
        </section>
